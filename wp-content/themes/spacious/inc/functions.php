...
function spacious_scripts_styles_method() {
	...
	*/
	wp_enqueue_style( 'spacious_style', get_stylesheet_uri() );
        wp_enqueue_style( 'custom_style', SPACIOUS_CSS_URL .'/custom.css' );
...
function spacious_footer_copyright() {
	$spacious_footer_copyright = '<div class="copyright">'.__( 'Copyright &copy; ', 'spacious' ).'[the-year] [site-link] </div>';
